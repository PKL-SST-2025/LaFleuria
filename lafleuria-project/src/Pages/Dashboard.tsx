...
export default function Dashboard() {
  return (
    <div class="flex h-screen font-sans bg-[#4A1D35]">
      {/* Sidebar */}
      <aside class="w-64 bg-gradient-to-b from-pink-100 to-pink-200 p-6 flex flex-col text-[#4A1D35]">
        {/* Logo */}
        <div class="flex items-center mb-8">
          <img src={logo} alt="Logo" class="h-8 mr-2" />
          <span class="font-semibold text-lg">La Fleuriá</span>
        </div>
        ...
        <div class="flex flex-col items-center text-center mb-10">
          <img
            src={profilePic}
            alt="Profile"
            class="h-16 w-16 rounded-full mb-2 object-cover border-2 border-pink-400"
          />
          <span class="text-sm font-semibold">Skylian Serafina</span>
        </div>

        {/* Navigation */}
        <nav class="flex flex-col gap-4">
          <A href="/dashboard" class="text-sm font-semibold hover:text-pink-500">
            Dashboard
          </A>
          <A href="/home" class="text-sm font-semibold hover:text-pink-500">
            Home
          </A>
          <A href="/product" class="text-sm font-semibold hover:text-pink-500">
            Product
          </A>
        </nav>
      </aside>
      ...
      {/* Main Content */}
      <main class="flex-1 bg-white p-8 overflow-y-auto rounded-tl-2xl">
        {/* Greeting Banner */}
        <div class="flex items-center bg-pink-100 rounded-xl px-6 py-4 mb-8">
          <div class="flex-1">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div class="grid grid-cols-2 gap-4 lg:col-span-2">
            <div class="bg-pink-100 p-4 rounded-xl text-center shadow-sm">
          ...
          {/* Detail Panel */}
          <div class="bg-pink-50 rounded-xl p-4 text-[#4A1D35] shadow-sm">
            <img src={bouquet1} alt="Elysian Bloom" class="h-32 mx-auto mb-4" />
            ...
            <p class="text-xs text-gray-700 mb-4 text-justify">
              Elysian Bloom is a gentle blend of elegance and serenity, featuring soft pastel tones of pink, ivory, blue, and yellow. With its graceful mix of roses, carnations, lilies, and hydrangeas, this bouquet is perfect for expressing pure affection and calm beauty. Whether for a birthday, anniversary, or a heartfelt surprise, Elysian Bloom delivers warmth and charm in every petal making it a timeless gift for those you truly cherish.
            </p>
            <div class="flex items-center justify-center gap-4 mb-3">
              <button class="bg-white px-3 py-1 border rounded">-</button>
              <span class="font-medium">02</span>
              <button class="bg-white px-3 py-1 border rounded">+</button>
            </div>
        ...
        {/* Popular Section */}
        <div class="bg-pink-50 rounded-xl p-4 flex items-center space-x-4 w-fit shadow-sm">
